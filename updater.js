...
function myhpUpdater (autoUpdate) {
    var updateURL;
    if(prefUpdateChannel=="release"){updateURL="https://raw.github.com/Habboeasy/script/";}else if(prefUpdateChannel=="beta"){updateURL="https://raw.github.com/Habboeasy/script/";}else{updateURL=prefUpdateCustomChannel;}
